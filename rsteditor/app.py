...
class RSTEditorFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        editmenu.Append(wx.ID_CUT, _('Cu&t'))
        editmenu.Append(wx.ID_COPY, _('&Copy'))
        editmenu.Append(wx.ID_PASTE, _('&Paste'))
        editmenu.Append(wx.ID_DELETE, _('&Delete'))
        editmenu.AppendSeparator()
        editmenu.Append(wx.ID_SELECTALL, _('Select &All\tCtrl+A'))
        editmenu.AppendSeparator()
        editmenu.Append(wx.ID_FIND, _('Find...'))
